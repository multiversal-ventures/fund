...
export const SCHEMA_TABLES = [
  ...
  {
    name: 'dc_market_scores',
    description: 'Data center adjacency Tier 1 county scores (full US; null scores when not dc_eligible).',
    approxRows: 3222,
    columns: [
      { name: 'fips', type: 'VARCHAR', description: 'County FIPS', tooltip: '' },
      { name: 'county', type: 'VARCHAR', description: 'County name', tooltip: '' },
      { name: 'state', type: 'VARCHAR', description: 'State abbreviation', tooltip: '' },
      { name: 'pop', type: 'BIGINT', description: 'Population', tooltip: '' },
      { name: 'dc_eligible', type: 'BOOLEAN', description: 'Leaderboard / percentile universe', tooltip: '' },
      { name: 'dc_market_score', type: 'DOUBLE', description: '0–100 composite', tooltip: '' },
      { name: 'zillow_url', type: 'VARCHAR', description: 'County browse on Zillow', tooltip: '' },
      { name: 's_electrical', type: 'DOUBLE', description: 'Electrical subscore', tooltip: '' },
      { name: 's_political', type: 'DOUBLE', description: 'Political subscore', tooltip: '' },
      { name: 's_pipeline', type: 'DOUBLE', description: 'NAICS 518 pipeline subscore', tooltip: '' },
      { name: 'dc_penalty', type: 'DOUBLE', description: 'Risk penalty', tooltip: '' },
    ],
  },
  {
    name: 'dc_tavily_state',
    description: 'State-level Tavily intel used in DC political signal.',
    approxRows: 51,
    columns: [
      { name: 'state_abbr', type: 'VARCHAR', description: 'State', tooltip: '' },
      { name: 'tavily_political_score', type: 'DOUBLE', description: '0–1 political tilt', tooltip: '' },
      { name: 'tavily_penalty', type: 'DOUBLE', description: 'Risk penalty input', tooltip: '' },
      { name: 'tavily_snippet_digest', type: 'VARCHAR', description: 'Concatenated search snippets', tooltip: '' },
      { name: 'tavily_sources_json', type: 'VARCHAR', description: 'JSON array of {url,title}', tooltip: '' },
    ],
  },
  {
    name: 'bls_2023',
